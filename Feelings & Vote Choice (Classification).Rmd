...
The trained model had a 72% accuracy. While not as accurate as the policy or 
feeling models, someone's vote choice can be estimated with 72% accuracy just
by knowing their age, maritial status, race/ethnicity, education level, and 
views on religion. 
...
The final model had an impressive 95% accuracy, so there was a slight improvement
on the full model over just the policy and just feelings. My largest take-away
from this data is how much predictive power that feelings had. Their were only 
